...
abstract class StateX<T extends StatefulWidget> extends State<StatefulWidget>
  ...
  StateX([this._controller]) : currentErrorFunc = FlutterError.onError {
    ...
    /// IMPORTANT! Assign itself to stateView before adding any StateXController. -gp
    _stateX = this;
...
mixin _ControllerListing {
  ...
  String add(StateXController? con) {
    ...
    if (con == null) {
      ...
      /// This connects the StateXController to this View!
...
abstract class AppStateX<T extends AppStatefulWidget>
  ...
  final Set<Map<String, StateX>> _states = {};
  ...
  Map<String, StateX> getStates(List<String> keys) {
